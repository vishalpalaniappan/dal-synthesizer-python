...
class SynthesizeNode:
    ...
    def getCmdGetInputAst(self, node):
        '''
    ...
    def getCmdDisplayAst(self, node):
        '''
    ...
    def getCmdIsEqualAst(self, node):
        '''
    ...
    def getCmdGetFromPosAst(self, node):
        '''
    ...
    def getCmdRemoveFromPosAst(self, node):
        '''
